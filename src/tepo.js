...
<section id="create-page" className="auth">
        <form id="create">
            <div className="container">
                ...
                <input type="text" id="imageUrl1" name="imageUrl" placeholder="Upload a photo..." />

                <label htmlFor="summary">Summary:</label>
                <textarea name="summary" id="summary"></textarea>
                <input className="btn submit1" type="submit" value="Create Game" />
                <input className="btn submit" type="submit1" value="Create Game" >
    ...
    <section id="catalog-page">
        ...
        <div className="allGames">
            <div className="allGames-info">
                ...
                <h6>Action</h6>
                <h2>MineCraft</h2>
                <a href="#" className="details-button">Details</a>>>>.>>></img/>
            </div>
        </div>
